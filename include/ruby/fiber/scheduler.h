 ...
 * @internal
 *
 * @shyouhei have  never seen a use  case where this function  is useful.  That
 * doesn't immediately mean anything though.
 */
 ...
 * @internal
 *
 * @shyouhei have  never seen  a scheduler  implementation that  has `#io_read`
 * yet.  This API seems waiting for one.
 */
 ...
 * @internal
 *
 * @shyouhei have  never seen a  scheduler implementation that  has `#io_write`
 * yet.  This API seems waiting for one.
 */
