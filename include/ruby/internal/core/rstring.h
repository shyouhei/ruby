...
enum ruby_rstring_flags {
     ...
     * store a string.  It was a failure to expose this to them.
     */
     ...
     * @internal
     *
     * Fstrings are not the only variant  strings that we implement today.  But
     ...
     * need not be exposed to extension libraries.
     */
