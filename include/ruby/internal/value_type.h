...
#define T_PAYLOAD  RUBY_T_PAYLOAD  /**< @old{RUBY_T_PAYLOAD} */
 ...
 * @private
 *
 * This is an implementation detail of Check_Type().  Just don't use it.
 *
 ...
 * @internal
 *
 * Practically this function never returns,  because Check_Type() calls it only
 * on failure.
 *
