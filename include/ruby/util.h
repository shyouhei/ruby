...
RBIMPL_ATTR_NONNULL(())
/**
 * Interprets  the passed  string  as  an octal  usigned  integer.  Stops  when
...
RBIMPL_ATTR_NONNULL(())
/**
 * Interprets  the passed  string a  hexadecimal usigned  integer.  Stops  when
 * encounters something not understood.
 *
 * @param[in]   str  C string to scan.
 * @param[in]   len  Length of `str`.
 ...
 * locale settings.
 *
 * @param[in]   str     Decimal or hexadeciml representation of a flating point
 *                      number.
